...
import { ShoppingCart, Loader2, Eye, Sparkles, Star, Package } from "lucide-react";
...
const Combos = () => {
  ...
  const fetchComboProducts = async () => {
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to load combo products. Please try again.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12 animate-fade-in">
          <div className="inline-flex items-center gap-3 mb-6">
            ...
            <Package className="w-5 h-5 text-secondary animate-pulse" style={{ animationDelay: '0.5s' }} />
          </div>
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            Get more bang for your buck with our specially curated combo packs
          </p>
        </div>
        ...
        {loading ? (
          <div className="flex flex-col justify-center items-center py-32">
            ...
            <p className="text-muted-foreground text-lg">Loading combo packs...</p>
          </div>
        ) : products.length === 0 ? (
          <div className="text-center py-32 animate-fade-in">
            ...
            <h3 className="text-2xl font-bold mb-2">No combo packs available</h3>
            <p className="text-muted-foreground mb-6">Check back soon for amazing combo deals!</p>
          ...
          <div className="mt-16 text-center animate-fade-in">
            <div className="inline-flex items-center gap-3 text-muted-foreground">
              ...
              <span className="text-sm font-medium">
                Showing {products.length} combo {products.length === 1 ? 'pack' : 'packs'}
              </span>
